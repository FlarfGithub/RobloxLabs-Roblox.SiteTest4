	...
	(function ($) {
					...
					scrollParent = this.parents()
						.filter(function () {
							return (
								...
								/(auto|scroll)/.test(
									$.curCSS(this, 'overflow', 1) + $.curCSS(this, 'overflow-y', 1) + $.curCSS(this, 'overflow-x', 1),
								)
							);
						})
						.eq(0);
		...
		$.ui.mouse = {
			...
			_mouseDistanceMet: function (event) {
				return (
					Math.max(Math.abs(this._mouseDownEvent.pageX - event.pageX), Math.abs(this._mouseDownEvent.pageY - event.pageY)) >=
