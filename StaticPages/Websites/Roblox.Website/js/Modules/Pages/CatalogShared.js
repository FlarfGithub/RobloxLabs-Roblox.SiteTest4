...
(Roblox.CatalogShared = Roblox.CatalogShared || {}),
	(Roblox.CatalogShared = (function () {
		function t(t, i, r, u) {
			t &&
				r &&
				r.length !== 0 &&
				(r.css('cursor', 'progress'),
				$.get(t, i, function (i) {
					if ((r.html(i), r.css('cursor', 'default'), !u)) {
						var f = $.Event(n, { url: t });
						r.trigger(f);
					}
				}));
		}
		var n = 'CatalogLoadedViaAjax';
		return { LoadCatalogAjax: t, CatalogLoadedViaAjaxEventName: n };
	})());
