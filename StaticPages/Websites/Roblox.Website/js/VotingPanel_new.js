	...
	var getModalProperties = function (modalType) {
		...
		var modalProperties = {
			EmailIsVerified: {
				...
				bodyContent:
					'You must verify your email before you can vote. You can verify your email on the ' + accountsPageLink + ' page.',
				onAccept: function () {
			...
			GuestUser: {
				...
				bodyContent:
					'<div>' + 'You must login to vote.' + '</div><div>' + 'Please ' + registerPageLink + ' to continue.' + '</div>',
				onAccept: function () {
