// PlaceLauncher.js
var RBX = {},
	RobloxLaunchStates = { StartingServer: 'StartingServer', StartingClient: 'StartingClient', Upgrading: 'Upgrading', None: 'None' },
	RobloxLaunch = {
	...
	RobloxPlaceLauncherService = {
		LogJoinClick: function () {
			$.get('/Game/Placelauncher.ashx', { request: 'LogJoinClick' });
		},
		RequestGame: function (n, t, i, r, u, f) {
			(i = i !== null && i !== undefined ? i : ''),
				$.getJSON('/Game/PlaceLauncher.ashx', { request: 'RequestGame', placeId: n, isPartyLeader: t, gender: i }, function (n) {
					n.Error ? u(n.Error, f) : r(n, f);
				});
		},
		RequestPlayWithParty: function (n, t, i, r, u, f) {
			$.getJSON('/Game/PlaceLauncher.ashx', { request: 'RequestPlayWithParty', placeId: n, partyGuid: t, gameId: i }, function (n) {
				n.Error ? u(n.Error, f) : r(n, f);
			});
		},
		RequestGroupBuildGame: function (n, t, i, r) {
			$.getJSON('/Game/PlaceLauncher.ashx', { request: 'RequestGroupBuildGame', placeId: n }, function (n) {
				n.Error ? i(n.Error, r) : t(n, r);
			});
		},
		RequestFollowUser: function (n, t, i, r) {
			$.getJSON('/Game/PlaceLauncher.ashx', { request: 'RequestFollowUser', userId: n }, function (n) {
				n.Error ? i(n.Error, r) : t(n, r);
			});
		},
		RequestGameJob: function (n, t, i, r, u, f) {
			$.getJSON('/Game/PlaceLauncher.ashx', { request: 'RequestGameJob', placeId: n, gameId: t, gameJobId: i }, function (n) {
				n.Error ? u(n.Error, f) : r(n, f);
			});
		},
		CheckGameJobStatus: function (n, t, i, r) {
			$.getJSON('/Game/PlaceLauncher.ashx', { request: 'CheckGameJobStatus', jobId: n }, function (n) {
				n.Error ? i(n.Error, r) : t(n, r);
			});
		},
		RequestPrivateGame: function (n, t, i, r, u, f) {
			(i = i !== null && i !== undefined ? i : ''),
				$.getJSON(
					'/Game/PlaceLauncher.ashx',
					{ request: 'RequestPrivateGame', placeId: n, accessCode: t, gender: i },
					function (n) {
						n.Error ? u(n.Error, f) : r(n, f);
					},
				);
...
(RobloxLaunch.RequestPlayWithParty = function (n, t, i, r) {
	EventTracker.start('Launch'),
		...
		checkRobloxInstall() &&
			(RobloxLaunch.launcher === null && (RobloxLaunch.launcher = new RBX.PlaceLauncher(n)),
	...
	(RobloxLaunch.RequestPrivateGame = function (n, t, i, r) {
		EventTracker.start('Launch'),
			RobloxPlaceLauncherService.LogJoinClick(),
			(RobloxLaunch.state = RobloxLaunchStates.None),
			checkRobloxInstall() &&
				(RobloxLaunch.launcher === null && (RobloxLaunch.launcher = new RBX.PlaceLauncher(n)),
				RobloxLaunch.launcher.RequestPrivateGame(t, i, r));
	}),
	(RobloxLaunch.RequestGroupBuildGame = function (n, t) {
		EventTracker.start('Launch'),
			...
			checkRobloxInstall() &&
				(RobloxLaunch.launcher === null && (RobloxLaunch.launcher = new RBX.PlaceLauncher(n)),
				RobloxLaunch.launcher.RequestGroupBuildGame(t));
	}),
	(RobloxLaunch.RequestGameJob = function (n, t, i, r) {
		EventTracker.start('Launch'),
			...
			checkRobloxInstall() &&
				(RobloxLaunch.launcher === null && (RobloxLaunch.launcher = new RBX.PlaceLauncher(n)),
				RobloxLaunch.launcher.RequestGameJob(t, i, r));
	}),
	...
	(RobloxLaunch.StartGameWork = function (n, t, i, r, u) {
		...
		(i = i.replace('http://', 'https://')),
			n.indexOf('http') >= 0 &&
				(n = typeof RobloxLaunch.SeleniumTestMode == 'undefined' ? n + '&testmode=false' : n + '&testmode=true'),
			typeof urchinTracker != 'undefined' && urchinTracker('Visit/Try/' + t),
		...
		try {
					...
					try {
						if (Roblox.Client._silentModeEnabled)
							f.SetSilentModeEnabled(!0),
								Roblox.VideoPreRoll.videoInitialized &&
									Roblox.VideoPreRoll.isPlaying() &&
									Roblox.Client.SetStartInHiddenMode(!0),
								f.StartGame(i, n),
								RobloxLaunch.CheckGameStarted(f);
			...
			if (((e = a.message), e === 'User cancelled' && typeof urchinTracker != 'undefined'))
				return urchinTracker('Visit/UserCancelled/' + t), !1;
			try {
			...
			return (
				Roblox.Client.isRobloxBrowser()
					? typeof urchinTracker != 'undefined' && urchinTracker('Visit/Fail/' + o + encodeURIComponent(e))
					: (typeof urchinTracker != 'undefined' && urchinTracker('Visit/Redirect/' + o + encodeURIComponent(e)),
		...
		try {
			if (typeof window.external != 'undefined' && window.external.IsRoblox2App) window.external.StartGame(i, t, n);
				...
				try {
					...
					try {
						Roblox.Client.IsIE() ? (r.AuthenticationTicket = i) : r.Put_AuthenticationTicket(i);
					} catch (h) {}
					try {
						if (Roblox.Client._silentModeEnabled)
							r.SetSilentModeEnabled(!0),
								Roblox.VideoPreRoll.videoInitialized &&
									Roblox.VideoPreRoll.isPlaying() &&
									Roblox.Client.SetStartInHiddenMode(!0),
								r.StartGame(t, n),
								RobloxLaunch.CheckGameStarted(r);
						else throw 'silent mode is disabled, fall back';
					} catch (h) {
						if ((r.StartGame(t, n), Roblox.Client._bringAppToFrontEnabled))
							try {
								r.BringAppToFront();
							} catch (e) {}
	...
	(RobloxLaunch.CheckGameStarted = function (n) {
		function r() {
			try {
				if (
					(i || (i = Roblox.Client.IsIE() ? n.IsGameStarted : n.Get_GameStarted()),
					i && !u && (EventTracker.endSuccess('StartClient'), EventTracker.endSuccess('Launch'), (u = !0)),
					i && !Roblox.VideoPreRoll.isPlaying())
				) {
					if (
	...
	(RBX.PlaceLauncher.prototype = {
		_showDialog: function () {
			var t, n;
			(this._cancelled = !1),
				(_popupOptions = { escClose: !0, opacity: 80, overlayCss: { backgroundColor: '#000' } }),
				this._popupID == 'PlaceLauncherStatusPanel' &&
					(Roblox.VideoPreRoll && Roblox.VideoPreRoll.showVideoPreRoll && !Roblox.VideoPreRoll.isExcluded()
						? ((this._popup = $('#videoPrerollPanel')),
						  (_popupOptions.onShow = function (n) {
						  ...
						  (_popupOptions.closeHTML =
								'<a href="#" class="ImageButton closeBtnCircle_35h ABCloseCircle VprCloseButton"></a>'))
		...
		_updateStatus: function (n) {
			MadStatus.running ||
				(MadStatus.init($(this._popup).find('.MadStatusField'), $(this._popup).find('.MadStatusBackBuffer'), 2e3, 800),
				MadStatus.start());
			switch (n) {
				case 0:
					break;
			...
			$(this._popup).find('.MadStatusStarting').css('display', 'none'),
				$(this._popup)
					.find('.MadStatusSpinner')
					.css('visibility', n === 3 || n === 4 || n === 5 ? 'hidden' : 'visible');
		},
		...
		RequestGame: function (n, t) {
			...
			var f = function (n, t) {
				...
				i = !1;
			return (
				typeof Party != 'undefined' && typeof Party.AmILeader == 'function' && (i = Party.AmILeader()),
				(r = function () {
		...
		RequestPrivateGame: function (n, t, i) {
			this._showDialog();
			var f = function (n, t) {
					t._onGameStatus(n);
				},
				...
				r = this,
				u = function () {
					EventTracker.start('GetConnection'), RobloxPlaceLauncherService.RequestPrivateGame(n, t, i, f, e, r);
				};
