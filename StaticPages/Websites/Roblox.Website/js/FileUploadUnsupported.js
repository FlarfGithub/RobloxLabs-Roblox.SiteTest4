$(function () {
	if (
		...
		typeof Roblox.FileUploadUnsupported != 'undefined' &&
		typeof Roblox.FileUploadUnsupported.Resources != 'undefined'
	) {
		$("input[type='file']:disabled").after(
			"<div style='color:red;font-size:11px'>" + Roblox.FileUploadUnsupported.Resources.notSupported + '</div>',
		);
	}
});
