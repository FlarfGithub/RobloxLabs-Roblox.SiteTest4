	...
	var i = new (function () {
		...
		u = function (t, r, u) {
			...
			e
				? (i.remove(t),
				  (f = u - e),
				  n.logMetrics && console.log('[event]', t, r, f),
				  n.transmitMetrics &&
						$.ajax({
							type: 'GET',
							async: !0,
...
typeof Roblox == 'undefined' && (Roblox = {}),
	(Roblox.InstallationInstructions = (function () {
		function i() {
			...
			loadImages(),
				(t = 0),
				(i = $('.InstallInstructionsImage')),
				i && typeof $(i).attr('modalwidth') != 'undefined' && (t = $('.InstallInstructionsImage').attr('modalwidth')),
				t > 0
					? ((r = ($(window).width() - (t - 10)) / 2),
		...
		function loadImages() {
			...
			navigator.userAgent.match(/Mac OS X 10[_|\.]5/)
				? n &&
				  typeof $(n).attr('oldmacdelaysrc') != 'undefined' &&
				  $('.InstallInstructionsImage').attr('src', $('.InstallInstructionsImage').attr('oldmacdelaysrc'))
				: n &&
				  typeof $(n).attr('delaysrc') != 'undefined' &&
...
(function () {
	...
	Roblox.Client.WaitForRoblox = function (n) {
		return u() && !r()
			? ($('#IEMetroInstructions').modal({ overlayClose: !0, escClose: !0, opacity: 80, overlayCss: { backgroundColor: '#000' } }),
			  !1)
			: i(n);
	};
})(window);
