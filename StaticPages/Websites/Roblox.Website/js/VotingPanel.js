...
Roblox.Voting = (function () {
	var i = function (n) {
		...
		t = function (t, i) {
			var r, u;
			if ((Roblox.Voting.CanVote(), (r = $('.voting-panel').attr('data-vote-modal')), r != undefined && r.length > 0))
				switch (r) {
					...
					case 'InstallPlugin':
						Roblox.GenericModal.open(
							Roblox.Voting.Resources.installPluginTitle,
							null,
							Roblox.Voting.Resources.installPluginMessage,
						);
						return;
					case 'BuyGamePass':
						Roblox.GenericModal.open(
							Roblox.Voting.Resources.buyGamePassTitle,
							null,
							Roblox.Voting.Resources.buyGamePassMessage,
						);
						return;
				}
			else
				(u = $('.voting-panel').data('asset-id')),
					t.hasClass('selected') ? Roblox.Voting.Unvote(u, n) : Roblox.Voting.Vote(u, i, n);
		},
		n = function () {
			$('.users-vote .upvote')
				.unbind()
