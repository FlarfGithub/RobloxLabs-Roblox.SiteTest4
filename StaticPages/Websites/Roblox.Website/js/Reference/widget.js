...
Roblox.BootstrapWidgets = (function () {
	...
	SetupDropdown = function () {
		...
		$('[data-toggle="dropdown-menu"] li').click(function (e) {
			...
			target.closest('.rbx-input-group-btn').find('[data-bind="label"]').text(target.text()).end().toggleClass('open');
			return false;
		});
	};
	...
	SetupAccordion = function () {
		...
		$('[data-toggle="collapsible-element"]').on('show.bs.collapse', function (e) {
			$(e.target)
				...
				.removeClass('rbx-icon-right-16x16')
				.addClass('rbx-icon-down-16x16');
		});
		...
		$('[data-toggle="collapsible-element"]').on('hide.bs.collapse', function (e) {
			$(e.target)
				...
				.removeClass('rbx-icon-down-16x16')
				.addClass('rbx-icon-right-16x16');
		});
	};
