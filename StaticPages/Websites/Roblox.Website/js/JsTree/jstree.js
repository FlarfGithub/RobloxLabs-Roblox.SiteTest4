		...
		init: function (el, options) {
			...
			this.element.html(
				'<' +
					...
					"li id='j" +
					this._id +
					"_loading' class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='presentation'><i class='jstree-icon jstree-ocl'></i><" +
					"a class='jstree-anchor' role='treeitem' href='#'><i class='jstree-themeicon-hidden'></i>" +
			...
			if (!skip_loading) {
				this.element.html(
					'<' +
						...
						c +
						"' role='group'><" +
						"li class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='presentation' id='j" +
						this._id +
