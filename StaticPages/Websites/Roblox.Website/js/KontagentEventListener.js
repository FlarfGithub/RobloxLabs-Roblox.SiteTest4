...
(KontagentListener = new RBXBaseEventListener()),
	...
	(KontagentListener.handleEvent = function (n, t) {
		function r(n) {
		...
		switch (n.type) {
			...
			case 'rbx_evt_newuser':
				(t.eventName = 'New User'),
					(t.eventType = 'New User'),
					(i = {
						guid: 's',
						eventType: 'st1',
						eventName: 'n',
			...
			case 'rbx_evt_install_begin':
				(t.eventName = 'Download'),
					(t.eventType = 'Download'),
					(i = {
						guid: 's',
						eventType: 'st1',
						os: 'st2',
			...
			case 'rbx_evt_initial_install_start':
				(t.eventName = 'Bootstrap Install Begin'),
					(t.eventType = 'Bootstrap Install Begin'),
					(i = {
						guid: 's',
						eventType: 'st1',
						os: 'st2',
			...
			case 'rbx_evt_initial_install_success':
				(t.eventName = 'Bootstrap Install Success'),
					(t.eventType = 'Bootstrap Install Success'),
					(t.os = r(t.os)),
					(i = {
						guid: 's',
						eventType: 'st1',
				...
				break;
			case 'rbx_evt_ftp':
				(t.eventName = 'First Time Play'),
					(t.eventType = 'First Time Play'),
					(t.os = r(t.os)),
					(i = {
						guid: 's',
						eventType: 'st1',
				...
				break;
			case 'rbx_evt_fmp':
				(t.eventName = 'Five Minute Play'),
					(t.eventType = 'Five Minute Play'),
					(t.os = r(t.os)),
					(i = {
						guid: 's',
						eventType: 'st1',
				...
				break;
			case 'rbx_evt_odr':
				(t.eventName = 'One Day Return'),
					(t.eventType = 'One Day Return'),
					(i = {
						guid: 's',
						eventType: 'st1',
						eventName: 'n',
				...
				break;
			case 'rbx_evt_sdr':
				(t.eventName = 'Seven Day Return'),
					(t.eventType = 'Seven Day Return'),
					(i = {
						guid: 's',
						eventType: 'st1',
						eventName: 'n',
			...
			case 'rbx_evt_generic':
				(t.eventName = t.type),
					...
					typeof t.opt1 != 'undefined' && (i.opt1 = 'st2'),
					typeof t.opt2 != 'undefined' && typeof t.opt1 != 'undefined' && (i.opt2 = 'st3');
				break;
			case 'rbx_evt_popup_action':
				(t.eventType = 'GuestPlayPopupAction'),
					(t.eventName = 'GuestPlayPopupAction'),
					(i = {
						guid: 's',
						eventType: 'st1',
						action: 'st2',
