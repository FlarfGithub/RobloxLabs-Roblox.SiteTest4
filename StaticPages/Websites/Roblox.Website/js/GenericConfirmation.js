...
if (typeof Roblox.GenericConfirmation === 'undefined') {
	Roblox.GenericConfirmation = (function () {
		...
		function open(properties) {
			...
			if (properties.allowHtmlContentInBody) $("[data-modal-handle='confirmation'] div.Message").html(properties.bodyContent);
			else $("[data-modal-handle='confirmation'] div.Message").text(properties.bodyContent);
			...
			else $('[data-modal-handle="confirmation"] div.ConfirmationModalFooter').text(properties.footerText);
