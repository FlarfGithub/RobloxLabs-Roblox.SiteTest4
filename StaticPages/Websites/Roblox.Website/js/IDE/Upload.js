...
if (typeof Roblox.Studio.AssetUpload === 'undefined') {
	Roblox.Studio.AssetUpload = (function () {
		...
		var uploadSuccess = function (result) {
			...
			if (newUpload && Roblox.Studio.AssetUpload.IsPlace) {
				//don't show share if new place
				$('#nextButton').show();
			} else if (newUpload && !Roblox.Studio.AssetUpload.IsPlace) {
				//if new model, we need to get avid
				$('#okButton').show();
