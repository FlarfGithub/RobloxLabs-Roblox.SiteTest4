...
Roblox.Icons.Init = function () {
	...
	$('a#addIconButton').click(function () {
		...
		if ($('#iconImageFile').val()) {
				...
				onAccept: function () {
					...
					$.ajax({
						...
						error: function () {
							...
							button.show();
							uploadStatus
								.html(Roblox.Resources.Icons.ErrorText)
			...
			uploadStatus.html(Roblox.Resources.Icons.EmptyText).removeClass('status-confirm').addClass('error-message').show();
		}
	});
		...
		function addGeneratedImage() {
			...
			$.ajax({
				...
				error: function () {
					loadingImage.hide();
					button.show();
					uploadStatus.html(Roblox.Resources.Icons.ErrorText).removeClass('status-confirm').addClass('error-message').show();
				},
				data: formData,
				cache: false,
				contentType: false,
