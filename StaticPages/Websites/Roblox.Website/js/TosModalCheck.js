			...
			if (data.PartialViewName) {
				...
				if (data.PartialViewName === 'CaptureTosAgreement_v2') {
					if (intl) {
						...
						body = intl.f(data.LangResources['Message.AgreeToTosAndPrivacyBody'], {
							tosLinkStart: tosLink,
							tosLinkEnd: '</a>',
							privacyLinkStart: privacyLink,
							privacyLinkEnd: '</a>',
							legalChangesLinkStart: legalChangesLink,
						...
						body =
							'By clicking "I Agree", you are agreeing to the <a href="https://www.roblox.com/info/terms" class="text-link" target="_blank">Terms of Use</a> and <a href="https://www.roblox.com/info/privacy" class="text-link" target="_blank">Privacy Policy</a>. You can learn more about what is changing <a href="https://www.roblox.com/info/latest-changes" class="text-link" target="_blank">here</a>.';
						accept = 'I AGREE';
					}
					...
					if (intl) {
						...
						body = intl.f(data.LangResources['Message.TosAgreementBody'], {
							tosLinkStart: tosLink,
							tosLinkEnd: '</a>',
							legalChangesLinkStart: legalChangesLink,
							legalChangesLinkEnd: '</a>',
