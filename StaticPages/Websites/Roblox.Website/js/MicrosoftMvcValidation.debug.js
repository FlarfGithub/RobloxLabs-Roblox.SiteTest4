...
Sys.Mvc.FormContext._parseJsonOptions = function Sys_Mvc_FormContext$_parseJsonOptions(options) {
	...
	var validationSummaryElement = !Sys.Mvc._validationUtil.stringIsNullOrEmpty(options.ValidationSummaryId)
	...
	registeredValidatorCallbacks.push(
...
Sys.Mvc.RegularExpressionValidator.create = function Sys_Mvc_RegularExpressionValidator$create(rule) {
	...
	return Function.createDelegate(
		new Sys.Mvc.RegularExpressionValidator(pattern),
		new Sys.Mvc.RegularExpressionValidator(pattern).validate,
	);
};
...
Sys.Mvc.StringLengthValidator.create = function Sys_Mvc_StringLengthValidator$create(rule) {
	...
	return Function.createDelegate(
		new Sys.Mvc.StringLengthValidator(minLength, maxLength),
		new Sys.Mvc.StringLengthValidator(minLength, maxLength).validate,
	);
};
