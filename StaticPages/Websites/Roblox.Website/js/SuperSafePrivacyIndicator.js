...
if (typeof Roblox.SuperSafePrivacyMode === 'undefined') {
	Roblox.SuperSafePrivacyMode = (function () {
		function openSuperSafeModal() {
			Roblox.GenericModal.open(
				Roblox.SuperSafePrivacyMode.Resources.modalTitle,
				null,
				Roblox.SuperSafePrivacyMode.Resources.modalMsg,
				function () {},
			);
		}
		...
		function initModals() {
			$('[data-js-supersafeprivacymode]').each(function (index, html) {
				...
				if (self.hasClass('SuperSafePrivacyModeImg')) {
					//banner image
					self.click(function () {
						openSuperSafeModal();
					});
					...
					self.parent().css(
						'left',
						parent.find('input[data-js-supersafeprivacymode],textarea[data-js-supersafeprivacymode]').outerWidth() -
							self.outerWidth(),
					);
				} else {
					//disabled element
	...
	Roblox.SuperSafePrivacyMode.Resources = {
		modalMsg:
			"This feature is locked for users under 13 years of age. If your birthday is incorrect, go to the <a href='/My/Account.aspx'>Account</a> page to update it.",
